...
static void 
pre_<$function.name$>(<$argumentSpec_comma$>struct kedr_function_call_info* call_info)
{
...
static void 
post_<$function.name$>(<$argumentSpec_comma$><$if returnType$><$returnType$> ret_val, <$endif$>struct kedr_function_call_info* call_info)
{
	void *caller_address = call_info->return_address;
<$handler.post$>
}
