/*
 * Module which allows to trigger __kmalloc, krealloc and __krealloc calls.
 */
...
struct dentry* __kmalloc_trigger_file;
struct dentry* krealloc_trigger_file;
struct dentry* __krealloc_trigger_file;
