...
void indicator_instance_destroy(struct indicator_instance* instance)
{
...
void kedr_fsim_point_clear_indicator_internal(
    struct kedr_simulation_point* point)
{
...
void delete_point_files(struct kedr_simulation_point* point)
{
