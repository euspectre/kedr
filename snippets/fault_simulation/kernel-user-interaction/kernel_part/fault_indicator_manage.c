...
#include "fault_indicator_manage.h"
#include "../common.h" /* socket protocol for API*/

#include <linux/module.h>
#include <linux/list.h> /* list functions */

#include <fault_simulation/module_weak_ref.h>

/* kedr_target_module_in_init */
#include <cp_controller/controller_common.h>
#include <syscall_connector/syscall_connector.h>
